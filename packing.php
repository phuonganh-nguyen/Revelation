    ...
    <div class="orders">   
        ...
        <div class="container">
            <div class="arrow-steps order clearfix">
                ...
                <div class="step current" id="packing-link">
                ...
                <div class="step done" id="completed-link">
        ...
        <div class="box-container">
            <?php 
            $hasPendingOrders = false; // Khởi tạo biến để kiểm tra có đơn hàng nào đang đóng không
            ...
            if ($select_bill->rowCount() > 0) { 
                while ($fetch_bill = $select_bill->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    if ($trangthai == "Đóng hàng") {
                        $hasPendingOrders = true; // Đã tìm thấy đơn hàng đang đóng
            ...
            // Kiểm tra và hiển thị thông báo nếu không có đơn hàng nào đang đóng
            if (!$hasPendingOrders) {
                echo '<div class="empty"><p>Bạn không có đơn hàng nào đang chuẩn bị.</p></div>';
            }
            ?>
        </div>
    </div>
