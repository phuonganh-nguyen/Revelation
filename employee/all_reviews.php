...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_response'])) {
    ...
    if (!empty($response_content)) {
        ...
        $update_response = $conn->prepare("UPDATE danhgia SET phanhoi = ?, admin_id=? WHERE danhgia_id = ?");
        $update_response->execute([$response_content, $user_id, $review_id]);
...
<head>
    ...
    <title>révélation - All reviews page</title>
                ...
                <div class="box">
                    <table border="1" cellpadding="10" cellspacing="0" style="width:100%; text-align: left;">
                        ...
                        <?php
                            ...
                            $select_users = $conn->prepare("SELECT * FROM `danhgia` ORDER BY ngaygui DESC");
