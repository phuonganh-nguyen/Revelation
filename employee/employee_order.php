...
//bao gồm một tệp PHP khác vào tệp hiện tại
    ...
    if (isset($_POST['update_order'])) {
        ...
        $update_status = $conn->prepare("UPDATE `hoadon` SET trangthai=?, admin_id=? WHERE hoadon_id=?");
        $update_status->execute([$status, $user_id, $hoadon_id]);
                ...
                <div class="box order">
                    <table border="1" cellpadding="10" cellspacing="0" style="width:100%; text-align: left;">
                        ...
                        <?php
                            ...
                            $select_orders = $conn->prepare("SELECT b.bill_id, b.hoadon_id, b.user_id, b.name, b.tongthanhtoan, b.trangthai, b.ngaydat FROM bill b JOIN user u ON b.user_id = u.user_id ORDER BY b.ngaydat DESC");
                            ...
                            if ($select_orders->rowCount() > 0) {
                                ...
                                while ($fetch_order = $select_orders->fetch(PDO::FETCH_ASSOC)){
                                    ?>
                                    <tr onclick="window.location.href='update_order.php?get_id=<?= $fetch_order['bill_id']?>'">
