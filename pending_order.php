    ...
    <div class="orders">   
        ...
        <div class="container">
            <div class="arrow-steps order clearfix">
                ...
                <div class="step current" id="pending-link">
        ...
        <div class="box-container">
            <?php 
                ...
                $hasPendingOrders = false; // Biến để kiểm tra có đơn hàng nào "Chờ xác nhận" không
                ...
                if ($select_bill->rowCount() > 0) { 
                    while ($fetch_bill = $select_bill->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        if ($trangthai == "Chờ xác nhận") {
                            $hasPendingOrders = true; // Đã có ít nhất một đơn hàng "Chờ xác nhận"
                ...
                // Nếu không có đơn hàng nào "Chờ xác nhận"
                if (!$hasPendingOrders) {
                    echo '<div class="empty"><p>Bạn không có đơn hàng nào chờ xác nhận.</p></div>';
                }
            ?>
        </div>
    </div>
